            ...
            <footer className="bg-gray-900">
                <div className="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
                    <div className="text-center">
                        <h2 className="text-3xl font-extrabold text-white sm:text-5xl">Customise Your Product</h2>
                        ...
                        <a
                            href="#"
                            className="mt-8 inline-block rounded-full border border-indigo-400 px-12 py-3 text-sm font-medium text-indigo-400 hover:bg-indigo-600 hover:text-white focus:outline-none focus:ring active:bg-indigo-500"
                        >
                            Get Started
                        </a>
                    </div>
